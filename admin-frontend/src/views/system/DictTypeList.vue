  ...
  <div class="page">
    ...
    <el-card>
      <D2Table
        ...
        :have-edit="true"
        :have-detail="true"
        create-permission="dict_type:create"
        update-permission="dict_type:update"
        delete-permission="dict_type:delete"
...
const drawerColumns = computed<DrawerColumn[]>(() => [
  ...
  {prop: 'code', label: '字典编码', type: D2TableElemType.Tag},
...
const drawerAddColumns = computed<DrawerColumn[]>(() => [
  ...
  {prop: 'code', label: '字典编码', required: true},
  {prop: 'description', label: t('common.description')},
  {
    prop: 'status',
    label: t('common.status'),
