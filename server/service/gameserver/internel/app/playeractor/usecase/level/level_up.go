...
type LevelUpUseCase struct {
	...
	// 依赖其他系统（通过接口注入）
	moneyUseCase  interfaces2.MoneyUseCase  // 必须：同步经验货币
	attrUseCase   interfaces2.AttrUseCase   // 可选：属性脏标记
	rewardUseCase interfaces2.RewardUseCase // 必须：升级奖励
}
...
func (uc *LevelUpUseCase) SetDependencies(
	moneyUseCase interfaces2.MoneyUseCase,
	attrUseCase interfaces2.AttrUseCase,
