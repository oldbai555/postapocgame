...
func NewRegisterUseCase(repo repository.AccountRepository, tokenProvider interfaces.TokenGenerator) *RegisterUseCase {
...
func (uc *RegisterUseCase) Execute(ctx context.Context, input RegisterInput) (*RegisterResult, error) {
	...
	if err != nil && err != repository.ErrAccountNotFound {
		return nil, err
	}
