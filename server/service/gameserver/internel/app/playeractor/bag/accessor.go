...
func NewBagSnapshot(ctx context.Context, repo iface.PlayerRepository) (*Snapshot, error) {
...
func newAccessor(ctx context.Context, repo iface.PlayerRepository) (*accessor, error) {
