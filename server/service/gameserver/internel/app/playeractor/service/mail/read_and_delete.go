...
func NewReadMailUseCase(playerRepo iface.PlayerRepository) *ReadMailUseCase {
...
func NewDeleteMailUseCase(playerRepo iface.PlayerRepository) *DeleteMailUseCase {
